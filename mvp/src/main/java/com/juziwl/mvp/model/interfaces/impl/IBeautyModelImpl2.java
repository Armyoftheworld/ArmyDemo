...
import com.juziwl.mvp.model.interfaces.OnRefreshLoadingModel;
...
public class IBeautyModelImpl2 implements OnRefreshLoadingModel<ArrayList<Beauty>> {
    private Handler handler = new Handler(Looper.getMainLooper());

    @Override
    public void onRefresh(final OnDataLoadListener<ArrayList<Beauty>> listener) {
        new Thread() {
            @Override
            public void run() {
                try {
                ...
                try {
                    ...
                    beauties.add(new Beauty("张雨绮21", R.mipmap.beauty2, "好漂亮啊1"));
                    beauties.add(new Beauty("张雨绮22", R.mipmap.beauty2, "好漂亮啊2"));
                    beauties.add(new Beauty("张雨绮23", R.mipmap.beauty2, "好漂亮啊3"));
                    beauties.add(new Beauty("张雨绮24", R.mipmap.beauty2, "好漂亮啊4"));
                    beauties.add(new Beauty("张雨绮25", R.mipmap.beauty2, "好漂亮啊5"));
...
//                    beauties.add(new Beauty("张雨绮15", R.mipmap.beauty2, "好漂亮啊15"));
    ...
    @Override
    public void onLoading(OnDataLoadListener<ArrayList<Beauty>> listener) {
